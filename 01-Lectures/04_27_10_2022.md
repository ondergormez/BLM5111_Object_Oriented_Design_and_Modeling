...
En üsttekine kök düğüm, altındakilere yaprak (leaf). Komposite ler ise ara düğümlerdir.
...
* Dimond Inheritence: Çoklu kalıtım her dilde desteklenmez. Çoklu kalıtımda kalıtılan 2 sınıfta aynı base den inherit ediliyorsa, hangi override method kullanılacak problemi oluşmaktadır?
